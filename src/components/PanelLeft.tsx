...
type PanelLeftProps = {
  filters: Filters;
  onOpenFilter: () => void;
  // True while a streak glow is on the board — the only time the legend shows.
  legendVisible: boolean;
};

export default function PanelLeft({ filters, onOpenFilter, legendVisible }: PanelLeftProps) {
  return (
