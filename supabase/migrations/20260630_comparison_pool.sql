...
--   * DROP Trainer "Item"/"Stadium"/"Pokémon Tool" cards. This filter lives ONLY in
--     the app (api/comparison/next via excludedTrainerNames.ts, a name list from the
--     Pokemon TCG API) and is NOT mirrored here — a SQL version would want a real
--     subtype column.
